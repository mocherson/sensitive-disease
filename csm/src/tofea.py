...
### generate features
# lab feature
lab_idnm_case=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/lab{}_idnm_agg_{}.csv'.format(disease,thr))
lab_idnm_ctr=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/labnonSD5pct_idnm_agg_{}.csv'.format(ctr_thr))
...
lab_fea.to_csv('/home/data/sensitive_disease/csm/fea_mat/lab{}_fea_{}.csv'.format(disease,thr))
lab_fea.to_pickle('/home/data/sensitive_disease/csm/fea_mat/lab{}_fea_{}.pkl'.format(disease,thr))

#pr feature
pr_idnm_case=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/pr{}_idnm_agg_{}.csv'.format(disease,thr))
pr_idnm_ctr=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/prnonSD5pct_idnm_agg_{}.csv'.format(ctr_thr))
...
pr_fea.to_csv('/home/data/sensitive_disease/csm/fea_mat/pr{}_fea_{}.csv'.format(disease,thr))
pr_fea.to_pickle('/home/data/sensitive_disease/csm/fea_mat/pr{}_fea_{}.pkl'.format(disease,thr))

#med feature
med_idnm_case=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/med{}_idnm_agg_{}.csv'.format(disease,thr))
med_idnm_ctr=pd.DataFrame.from_csv('/home/data/sensitive_disease/csm/mednonSD5pct_idnm_agg_{}.csv'.format(ctr_thr))
...
med_fea.to_csv('/home/data/sensitive_disease/csm/fea_mat/med{}_fea_{}.csv'.format(disease,thr))
med_fea.to_pickle('/home/data/sensitive_disease/csm/fea_mat/med{}_fea_{}.pkl'.format(disease,thr))


lab_fea=pd.read_pickle('/home/data/sensitive_disease/csm/fea_mat/lab{}_fea_{}.pkl'.format(disease,thr))
pr_fea=pd.read_pickle('/home/data/sensitive_disease/csm/fea_mat/pr{}_fea_{}.pkl'.format(disease,thr))
med_fea=pd.read_pickle('/home/data/sensitive_disease/csm/fea_mat/med{}_fea_{}.pkl'.format(disease,thr))
...
fea.to_csv('/home/data/sensitive_disease/csm/fea_mat/fea{}_{}.csv'.format(disease,thr))
fea.to_pickle('/home/data/sensitive_disease/csm/fea_mat/fea{}_{}.pkl'.format(disease,thr))
